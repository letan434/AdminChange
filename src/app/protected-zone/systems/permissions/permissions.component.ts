...
import { NotificationService, UtilitiesService, CommandService, RolesService, AuthService } from '@app/shared/services';
...
export class PermissionsComponent implements OnInit, OnDestroy {
  ...
  public savePermission() {
    ...
    this.subscription.add(this.permissionsService.save(this.selectedRole.id, permissionsUpdateRequest)
      ...
      this._notificationService.showError(MessageConstants.ROLE_ERROR_MSG);
    }
  }
  loadData(roleId) {
    if (roleId != null) {
